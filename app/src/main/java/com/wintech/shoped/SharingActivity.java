...
import com.wintech.shoped.RVs.CardAdapter;
...
public class SharingActivity extends AppCompatActivity {
    ...
    Intent toAddItems, toClaims, toReminders, toRegistered, toServiceRequest, toProfile;
    CardAdapter rvforItemsAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        rvforItems = (RecyclerView) findViewById(R.id.sharing_items_rv);
        rvforItems.setHasFixedSize(true);

        rvforItemsAdapter = new CardAdapter(this, getItemData());

        rvforItems.setAdapter(rvforItemsAdapter);

        // use a linear layout manager
        myRegItemsRVLayoutManager = new LinearLayoutManager(SharingActivity.this);
